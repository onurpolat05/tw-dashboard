        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="mx-auto max-w-3xl text-sm text-gray-600 md:text-base">
              TradeWizz employs a diversified revenue model, combining recurring subscription revenue with transaction-based commissions from its integrated warehouse services and marketplace platform.
            </p>
          </div>
      ...
      <Card className="p-4 md:p-6 bg-[#F8F8F8]">
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="mx-auto max-w-3xl text-sm text-gray-600 md:text-base">
              This section presents the projected EBITDA for 2027 under three different scenarios.
            </p>
          </div>
      ...
      <Card className="p-4 md:p-6 bg-[#F8F8F8]">
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="mx-auto max-w-3xl text-sm text-gray-600 md:text-base">
              The financial projections are based on key assumptions regarding customer acquisition, retention, and operational efficiency.
            </p>
          </div>
