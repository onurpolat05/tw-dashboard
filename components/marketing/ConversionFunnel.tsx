      ...
      <CardHeader className="flex-none px-0 pt-0">
        <div className="flex flex-col gap-2 justify-between mb-4 md:flex-row md:items-center md:gap-0 md:mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">Marketing funnel stages and conversion rates</p>
          </div>
          <span className="text-xs font-medium text-purple-600 md:text-sm">Target Conversion: 0.5% - 2%</span>
        </div>
      </CardHeader>
        ...
        <div className="pt-8 mt-8 border-t border-gray-200">
          <div className="grid grid-cols-2 gap-4 md:gap-8">
            <div className="text-center">
              <p className="mb-2 text-base text-gray-600 md:text-lg">Conversion Rate</p>
              <p className="text-2xl font-bold text-purple-600 md:text-3xl">1.17%</p>
            </div>
            <div className="text-center">
              <p className="mb-2 text-base text-gray-600 md:text-lg">Cost per Customer</p>
              <p className="text-2xl font-bold text-purple-600 md:text-3xl">$5.03</p>
            </div>
          </div>
        </div>
      </CardContent>
