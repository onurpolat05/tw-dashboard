      ...
      <Card className="p-6">
        <CardHeader className="px-0 pt-0">
          <div className="flex justify-between items-center mb-6">
            <div>
              <CardTitle className="mb-1 text-xl">Conversion Funnel</CardTitle>
          ...
          <div className="mb-8 space-y-4">
            {mockPurchaseFunnelData.map((item, index) => {
              ...
              return (
                ...
                >
                  <div
                    className="flex absolute inset-0 justify-between items-center px-6"
                    style={{
          ...
          <div className="pt-6 mt-8 border-t border-gray-200">
            <div className="grid grid-cols-2 gap-8">
              <div className="text-center">
                <p className="mb-1 text-base text-gray-600">Conversion Rate</p>
                <p className="text-2xl font-bold text-purple-600">0.02%</p>
              </div>
              <div className="text-center">
                <p className="mb-1 text-base text-gray-600">Cost per Customer</p>
